...
/**
 * Widget which displays links to help pages.
 * 
 * @author Johann Kohler
 */
@WebControllerPath(path = "/help")
public class HelpWidgetController extends WidgetController {

    @Inject
    public HelpWidgetController(ILinkGenerationService linkGenerationService, II18nMessagesPlugin i18nMessagePlugin) {
    ...
    public Promise<Result> display(Long widgetId) {
        ...
        return Promise.promise(new Function0<Result>() {
            ...
            public Result apply() throws Throwable {
                ...
                return ok(views.html.plugins.system.widgetkit1.help_widget.render(widgetId, DashboardWidgetColor.INFO.getColor(), tempLinkGenerator));
