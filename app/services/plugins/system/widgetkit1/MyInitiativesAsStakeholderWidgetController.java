 ...
 */
@WebControllerPath(path = "/my-initiativesAsStakeholder")
public class MyInitiativesAsStakeholderWidgetController extends WidgetController {
    ...
    @Inject
    public MyInitiativesAsStakeholderWidgetController(Configuration configuration, ILinkGenerationService linkGenerationService, ISecurityService securityService,
        ...
        return Promise.promise(new Function0<Result>() {
            ...
            public Result apply() throws Throwable {
                try {
                    ...
                    return ok(views.html.plugins.system.widgetkit1.my_initiatives_as_stakeholder_widget.render(widgetId, DashboardWidgetColor.DEFAULT.getColor(),
                            tempLinkGenerator, "as-stakeholder", myInitiativesData.asStakeholderTable, myInitiativesData.asStakeholderPagination));
                } catch (Exception e) {
        ...
        return Promise.promise(new Function0<Result>() {
            ...
            public Result apply() throws Throwable {
                try {
                    ...
                    MyInitiativesData myInitiativesData = getTables(actorId, asStakeholderPage);

                    return ok(views.html.plugins.system.widgetkit1.my_initiatives_as_stakeholder_fragment_widget.render(id, tempLinkGenerator, tab,
     ...
     * stakeholder
     */
    private MyInitiativesData getTables(Long actorId, Integer asStakeholderPage) {
        ...
        return new MyInitiativesData(asStakeholderTable, asStakeholderPagination);
    ...
    private static class MyInitiativesData {
         ...
         */
        public MyInitiativesData(Table<PortfolioEntryListView> asStakeholderTable, Pagination<PortfolioEntry> asStakeholderPagination) {
